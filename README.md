...
Optional PNG previews in `previews/` share the package filename stem and must fit 256 KiB. The original Ocean preview is retained; the larger Forest Piano and Soft White covers remain embedded in their packages.
